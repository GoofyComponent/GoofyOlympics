  ...
  return (
    <header className="flex justify-between h-20 w-full">
      <div className="flex justify-start">
        ...
        <div className="my-auto space-x-4 ml-6">
          <Link to="/" className="[&.active]:text-black text-black/60">
            Summary
          </Link>
          <Link to="/athletes" className="[&.active]:text-black text-black/60">
            Athletes
          </Link>
          <Link to="/countries" className="[&.active]:text-black text-black/60">
            Countries
          </Link>
        </div>
      </div>
